...
pub const Strings = struct {
    ...
    settings_system_proxy: []const u8,
    settings_proxy_address: []const u8,
    settings_proxy_system: []const u8,
    ...
    // —— 对话中心工作台 ——
    conversation_center_title: []const u8,
    conversation_center_source: []const u8,
    conversation_center_dates: []const u8,
    conversation_center_detail: []const u8,
    conversation_center_all_dates: []const u8,
    conversation_center_empty: []const u8,
    conversation_center_detail_empty: []const u8,
    conversation_center_detail_select: []const u8,
    conversation_center_footer: []const u8,
    conversation_center_resume: []const u8,
    conversation_center_search_placeholder: []const u8,
    cmd_palette_open_conversation_center: []const u8,
    ...
    sl_ai_oauth_api_key: []const u8,
    sl_ai_oauth_enter: []const u8,
    sl_ai_oauth_waiting: []const u8,
    sl_ai_oauth_connecting: []const u8,
    sl_ai_oauth_busy: []const u8,
    sl_ai_oauth_signed_in: []const u8,
    sl_ai_oauth_failed: []const u8,
...
const en = Strings{
    ...
    .settings_system_proxy = "Use proxy",
    .settings_proxy_address = "Proxy",
    .settings_proxy_system = "System proxy",
    ...
    .conversation_center_title = "Conversation Center",
    .conversation_center_source = "SOURCE",
    .conversation_center_dates = "DATE",
    .conversation_center_detail = "Preview",
    .conversation_center_all_dates = "All dates",
    .conversation_center_empty = "No conversations match these filters.",
    .conversation_center_detail_empty = "No conversation selected.",
    .conversation_center_detail_select = "Select a conversation to preview it.",
    .conversation_center_footer = "Enter: resume   Del: delete   Left/Right: filters/list/preview   Type: search",
    .conversation_center_resume = "Resume",
    .conversation_center_search_placeholder = "Search conversations",
    .cmd_palette_open_conversation_center = "Open Center",
    ...
    .sl_ai_oauth_api_key = "optional",
    .sl_ai_oauth_enter = "Enter to sign in",
    .sl_ai_oauth_waiting = "approve in the browser",
    .sl_ai_oauth_connecting = "Connecting…",
    .sl_ai_oauth_busy = "Sign-in already running",
    .sl_ai_oauth_signed_in = "Signed in",
    .sl_ai_oauth_failed = "Sign-in failed — Enter retries",
...
const zh_CN = Strings{
    ...
    .settings_system_proxy = "使用代理",
    .settings_proxy_address = "代理",
    .settings_proxy_system = "系统代理",
    ...
    .conversation_center_title = "对话中心",
    .conversation_center_source = "来源",
    .conversation_center_dates = "日期",
    .conversation_center_detail = "预览",
    .conversation_center_all_dates = "全部日期",
    .conversation_center_empty = "没有符合筛选条件的对话。",
    .conversation_center_detail_empty = "尚未选中对话。",
    .conversation_center_detail_select = "选择一条对话以预览内容。",
    .conversation_center_footer = "Enter：继续对话   Del：删除   ←→：筛选/列表/预览   输入：搜索",
    .conversation_center_resume = "继续",
    .conversation_center_search_placeholder = "搜索对话",
    .cmd_palette_open_conversation_center = "对话中心",
    ...
    .sl_ai_oauth_api_key = "可选",
    .sl_ai_oauth_enter = "回车登录",
    .sl_ai_oauth_waiting = "在浏览器中确认",
    .sl_ai_oauth_connecting = "正在连接…",
    .sl_ai_oauth_busy = "登录进行中",
    .sl_ai_oauth_signed_in = "已登录",
    .sl_ai_oauth_failed = "登录失败，回车重试",
...
pub fn commandDetail(action: CommandAction) ?[]const u8 {
    ...
    return switch (action) {
        ...
        .transpose_split => "把当前分屏在左右布局和上下布局之间切换",
        ...
        .open_conversation_center => "按日期筛选、预览并继续已保存的对话",
